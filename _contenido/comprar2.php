	...
	<div class="container">		
	    <div class="row description-cat">
	        ...
	        <div class="col-md-6">
		        ...
		        <li><p class="descripcion"><b>Vibradores bala</b>: Llamados así por su forma, son muy populares por su pequeño tamaño, muy práctico y económico para principiantes. Estimula el exterior de la vagina al ser presionado con tus manos.</p></li>	        
		        <li><p class="descripcion"><b>Masajeadores</b>: Al igual que las balas, estimulan el clítoris pero tienen mucha más potencia y son más grandes.</p></li>	        
		        <li><p class="descripcion"><b>Dobles</b>: Tienen un tronco para penetrar la vagina y un accesorio para estimular el exterior al mismo tiempo.</p></li>	        
		        <li><p class="descripcion"><b>Punto G</b>: Tienen la punta doblada hacia el interior de la pared frontal en el interior de la vagina, tienen contacto directo con el punto G.</p></li>	        
	    ...
	    <div class="row productos-cat">
			...
			<?php include("../comprar/copy/thumb.php"); ?>
			<?php include("../comprar/charlie-tango/thumb.php"); ?>
			<?php include("../comprar/tickler/thumb.php"); ?>
			<?php include("../comprar/lelo-mia-2/thumb.php"); ?>
			<?php include("../comprar/we-vibe-4/thumb.php"); ?>
	...
	<div class="container">		
	    <div class="row description-cat">
	        ...
	        <div class="descripcion col-md-6">
		        ...
		        <li><p class="descripcion">Los <b>dobles</b> tienen dos puntas apuntando al mismo lado, una para la vagina y la otra para el ano. También existen los <b>dobles para pareja</b>, en donde la pareja comparte el mismo consolador</p></li>
		        <p class="descripcion">Algunos tienen características especiales para estimular el punto G o para ser amarrados en un cinturon</p>
	        </div>
	    </div>	
	</div>
</section>
...
<!--Lubricantes -->
<section id="lubricantes" class="bg-light-gray" >
	<div class="container">		
	    <div class="row description-cat">
	        <div class="titulo col-xs-12">
	        ...
	        <div class="descripcion col-md-6">
		        ...
		        <li><p class="descripcion">Los <b>lubricantes a base de silicona</b> duran una eternidad pero necesitarás agua y jabón para removerlo por completo, son seguros para la vagina pero recomendados para sexo anal</p></li> 
	        </div>
	    </div>	
	</div>
</section>
	...
	<div class="container">		
	    <div class="row description-cat">
	        ...
	        <div class="descripcion col-md-6">
		        ...
		        <li><p class="descripcion">Los <b>anillos sólidos</b> se ponen cuando el pene está flácido, ejercen bastante presión en el pene y es recomendado sólo para expertos, pues hay que esperar a que el pene esté flácido de nuevo para removerlo. Mucho cuidado al usarlo.</p></li>
...
<!-- Fetiche -->
<section id="fetiche" class="bg-light-gray" >
	<div class="container">		
	    <div class="row description-cat">
	        <div class="titulo col-xs-12">
	        ...
	        <div class="descripcion col-md-6">
		        ...
		        <li><p class="descripcion"><b>Situaciones</b>, muchas personas fantasean con ser amarrados o hacer el amor en un avión</p></li>
		        <p class="descripcion">Si todavía no sabes cuál es tu fetiche, te invitamos a explorar 😋</p>
	        </div>
	    </div>	
	</div>
</section>
