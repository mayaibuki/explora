...
if($state_pol==1){
	...
	$mysqli->query("UPDATE orders SET name='$name', email='$email', city='$shippingCity', country='$shippingCountry', address='$shippingAddress', telephone='$telephone', transaction_date='$date', payed=false, amount='$value' WHERE order_id='$order->order_id' ")	or die('Could not query:' . mysqli_error());
