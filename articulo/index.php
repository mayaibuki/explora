...
<head>
    ...
    <meta name="description" content="XXXXdescription">
    <meta name="author" content="XXXXauthor">
    <link rel="alternate" hreflang="es" href="http://explora.life/" />
    
    
    <!--Opengrph-->
    <meta property="og:title" content="XXXXtitle" />
    <meta property="og:site_name" content="Explora.life"/>
    <meta property="og:url" content="http://explora.life/XXXXurl/" />
    <meta property="og:description" content="XXXXdescription" />
    <meta property="og:image" content="http://explora.life/media/articles/XXXXimg_fb.jpg" />

    <!-- twitter-->
	<meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:site" content="@explora_life">
	<meta name="twitter:creator" content="@explora_life">
	<meta name="twitter:title" content="XXXXtitle">
	<meta name="twitter:description" content="XXXXdescription">
	<meta name="twitter:image:src" content="http://explora.life/media/articles/XXXXimg_fb.jpg">
    ...
    <title>explora.life – XXXXtitle</title>
	...
	<div class="container">
	    <div class="row">
	        ...
	        <div class="col-md-5  article-img">
				<img src="../media/articles/XXXXimg_xl.jpg" alt="XXXXtitle" width="100%" height="" />	
	        ...
	        <div class="articulo col-sm-7 col-md-5">
	            <article>
					<h1>XXXXtitle</h1>
					<h5 class="text-secondary">Por XXXXauthor, XXXXdate</h5>
