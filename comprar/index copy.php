			    ...
			    <div class="row">
		            ...
		            <div class="col-xs-offset-1 col-xs-10 col-sm-offset-0 col-sm-5 text-center">	
						...
						<p class="text-center large">
							...
							echo '<a class="page-scroll" href="#'.$row['slug'].'">'.$row['name'].'</a>';
							$cat_count++;
							}
							?>
                        </p>
                ...
                <a href="/comprar/<?php echo $p_row['slug']; ?>/">
                    <div class="col-xs-6 col-sm-3 col-md-2">
                        ...
                        while ($img =  $imgs->fetch_assoc()) {
                            if($count==0){
                                echo '<div class="otros_imgbg animated pulse" style="background-image: url(/media/timthumb.php?src='. $img['full_img'] .'&w=200)"><h4>'.$p_row['name'].'</h4></div>'; 
                            }
                            $count++;
                        }
                        ?>
