...
<head>
    ...
    <meta name="description" content="5 razones por las que nos enamoramos de un hombre abusivo ficticio, Christian Grey de Fifty Shades of Grey o Cincuenta Sombras de Grey">
    ...
    <title>explora.life – Próximamente</title>
...
<body id="page-top" class="index">
    ...
    <!-- Header -->
    <div class="hero_img" style="background-image:url('../_img_articulos/notebook_xl.jpg');">
        <div class="container">
            <div class="intro-text">
                <div class="intro-heading">Próximamente</div>
                <div class="intro-lead-in">Artículo en desarrollo, suscríbete para saber cuando subamos nuevos artículos</div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-9 col-lg-8">
                    <div class="fb-comments" data-href="http://explora.life/vibrador_vs_consolador/" data-width="100%" data-numposts="5" data-colorscheme="light"></div>
                </div>
            </div>    
        </div>
    </section>
