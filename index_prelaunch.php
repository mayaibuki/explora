...
<head>
    ...
    <meta property="og:description" content="Promovemos la felicidad, la igualdad y la libertad sexual en Latino América, impulsando el entendimiento y la exploración de relaciones sanas y consensuales" />
    <meta property="og:image" content="http://explora.life/img/hero_big.jpg" />
...
<body id="page-top" class="index">
    	...
    	<?php include("_contenido/navigation_welcome.php"); ?>
    	<?php include("_contenido/header_welcome.php"); ?>
    	<?php include("_contenido/mision.php"); ?>
    	<?php include("_contenido/team_welcome.php"); ?>
